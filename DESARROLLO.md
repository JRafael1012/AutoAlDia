...
| **Etapa 4** | **Gestión de Vehículos (CRUD)** | Interfaz de garaje, registro/edición de vehículos, selección de vehículo activo global (`activeVehicleControllerProvider`), fotografía del auto y eliminación con limpieza física. | **Siguiente** |
